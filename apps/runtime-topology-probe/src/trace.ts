...
export const PROBE_SCENARIO_TOPOLOGY = {
  ...
  session_executor_invoke: [
    ...
    ["gateway_session_rtt", "external_request"],
    ["session_facet_rtt", "gateway_session_rtt"],
    ["facet_session_read_rtt", "session_facet_rtt"],
    ["facet_journal_io", "session_facet_rtt"],
    ["session_executor_finish", "gateway_session_rtt"],
    ["session_sync_wake_rtt", "session_executor_finish"],
    ["sync_cursor_io", "session_sync_wake_rtt"],
  ],
  sync_rerun: [
    ["external_request", null],
