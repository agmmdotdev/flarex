...
- Active checkpoint: replace duplicate codegen function metadata path `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
