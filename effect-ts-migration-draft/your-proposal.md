...
- Active checkpoint: replace codegen function required-args `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
