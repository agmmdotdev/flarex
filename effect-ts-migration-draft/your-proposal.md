...
- Active checkpoint: replace codegen module object validation `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
