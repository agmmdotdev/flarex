...
- Active checkpoint: replace codegen analysis functions-array validation `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
