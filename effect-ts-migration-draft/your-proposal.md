...
- Active checkpoint: replace missing codegen function deployment metadata `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
