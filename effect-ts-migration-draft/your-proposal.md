...
- Active checkpoint: replace codegen function metadata-match `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
