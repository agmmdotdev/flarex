...
- Active checkpoint: replace codegen analysis schema-mismatch `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
