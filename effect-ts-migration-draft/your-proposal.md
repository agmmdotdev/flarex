...
- Active checkpoint: replace codegen function moduleName mismatch validation `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
