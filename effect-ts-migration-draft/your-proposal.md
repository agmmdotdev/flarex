...
- Active checkpoint: replace codegen function exportName validation `HttpError(400)` failures with typed `DeploymentValidationError` while preserving start-route bad-request responses.
