...
export type Env = {
  ...
  FLAREX_TRUSTED_EXECUTION_IDENTITY?: string;
  FLAREX_TRUSTED_EXECUTION_IDENTITY_TOKEN?: string;
  FLAREX_ANALYZED_START_TOKEN?: string;
  FLAREX_LIVE_QUERY_DELIVERY_TOKEN?: string;
  FLAREX_QUERY_SYNC_PROBE_TOKEN?: string;
  FLAREX_SEMANTIC_ARTIFACT_V1_ROOT_CONFIGURATION?: string;
  FLAREX_SOURCE_ARTIFACT_V2_FINALIZED_READ_MAXIMUM_STORED_BYTES?: string;
  ARTIFACTS?: R2Bucket;
};
