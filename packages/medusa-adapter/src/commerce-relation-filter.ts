...
import { readCommerceRelationRows, type CommerceRelations, type CommerceRelation } from "./commerce-relations";
...
export const resolveCommerceRelationFilter = Effect.fn("MedusaAdapter.resolveRelationFilter")(function* (
  ...
  let rows = yield* readCommerceRelationRows(ctx, table, predicate);
  let roots: string[] = [];
