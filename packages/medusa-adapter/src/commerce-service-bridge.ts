...
import { capturePrivateJsonData, commerceError, CommerceTransactionError } from "@flarex/persistence-postgres/internal/commerce-values";
...
export const withCommerceService = Effect.fn("MedusaAdapter.withService")(function* <Service>(
  ...
  return yield* Effect.gen(function* () {
    ...
    return (yield* Effect.fromResult(capturePrivateJsonData(value, ctx.resources.commandBytes, commerceError))).value;
  }).pipe(
