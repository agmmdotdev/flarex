...
export default defineConfig({
 ...
 exclude: ["test/product-upstream.test.ts", "test/product-scale.test.ts", "test/product-types-upstream.test.ts", "test/product-tags-upstream.test.ts", "test/product-collections-upstream.test.ts", "test/product-options-upstream.test.ts", "test/product-variants-upstream.test.ts"],
