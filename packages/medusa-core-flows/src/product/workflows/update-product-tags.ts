import type { AdditionalData, ProductTypes } from "@medusajs/types"
import { ProductTagWorkflowEvents } from "../../events"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
import { updateProductTagsStep } from "../steps/update-product-tags"
