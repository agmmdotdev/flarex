...
import { upperCaseFirst } from "@medusajs/utils/common/upper-case-first"
import {
  MODULE_PACKAGE_NAMES,
  Modules,
} from "@medusajs/utils/modules-sdk/definition"
...
export const ModulesDefinition: {
  ...
  [Modules.ANALYTICS]: {
    ...
    label: upperCaseFirst(Modules.ANALYTICS),
    isRequired: false,
    isQueryable: false,
    dependencies: [ContainerRegistrationKeys.LOGGER],
    defaultModuleDeclaration: {
  ...
  [Modules.RBAC]: {
    key: Modules.RBAC,
    defaultPackage: false,
    label: upperCaseFirst(Modules.RBAC),
    isRequired: false,
    isQueryable: true,
    dependencies: [ContainerRegistrationKeys.LOGGER],
    defaultModuleDeclaration: {
  ...
  [Modules.TRANSLATION]: {
    ...
    defaultPackage: false,
    label: upperCaseFirst(Modules.TRANSLATION),
    isRequired: false,
    isQueryable: true,
    dependencies: [ContainerRegistrationKeys.LOGGER],
    defaultModuleDeclaration: {
