...
import { MedusaContext } from "@medusajs/utils/modules-sdk/decorators/context-parameter"
...
export class Link {
  ...
  constructor(modulesLoaded: LoadedModule[]) {
    // Portable construction has no process-global module/bootstrap fallback.
