...
export type StaticModuleResources = {
  models: ModulePersistenceModel[]
  services: Constructor<object>[]
  repositories: Constructor<RepositoryService>[]
...
export interface ModulePersistenceModel {
  name: string
}

export interface ModulePersistenceMutationEventArgs {
  entity: {
    id?: unknown
    deleted_at?: unknown
  }
...
export interface ModulePersistenceMutationService {
...
export interface ModulePersistenceEventSubscriber {
  new (context: Context): ModulePersistenceEventSubscriberInstance
}

export interface ModulePersistenceEventSubscriberInstance {
  afterCreate?(args: ModulePersistenceMutationEventArgs): Promise<void> | void
  afterUpdate?(args: ModulePersistenceMutationEventArgs): Promise<void> | void
  afterUpsert?(args: ModulePersistenceMutationEventArgs): Promise<void> | void
  afterDelete?(args: ModulePersistenceMutationEventArgs): Promise<void> | void
}

export interface ModulePersistenceAdapter {
  readonly name: string
  prepareModels(models: ModulePersistenceModel[]): ModulePersistenceModel[]
  createConnectionLoader(options: {
    moduleName: string
    moduleModels: ModulePersistenceModel[]
    migrationsPath?: string
  }): ModuleLoaderFunction
  createBaseRepository(): Constructor<RepositoryService>
  createRepository(
    model: ModulePersistenceModel
  ): Constructor<RepositoryService>
  createCustomRepository?(options: {
    model?: ModulePersistenceModel
    moduleModels?: Record<string, ModulePersistenceModel>
    repositoryName?: string
    repository: Constructor<RepositoryService>
  }): Constructor<RepositoryService> | undefined
  ...
  dispatchMutationEvent?(
    event: keyof ModulePersistenceEventSubscriberInstance,
    args: ModulePersistenceMutationEventArgs,
    context: Context,
    subscriber?: ModulePersistenceEventSubscriber
  ): Promise<void> | void
...
export interface ModuleMigrationScripts {
  runMigrations?(
...
export interface ModuleMigrationAdapter {
  readonly name: string
...
export type ModuleServiceInitializeCustomDataLayerOptions = {
  ...
  migrationAdapter?: ModuleMigrationAdapter
  repositories?: {
