...
--> statement-breakpoint
ALTER TABLE "fx_system_declarative_v2_verifier_attempt_v2" ADD CONSTRAINT "fx_dv2_attempt_v2_candidate_fk" FOREIGN KEY ("scope_id","candidate_sha256") REFERENCES "fx_system_declarative_v2_candidate"("scope_id","candidate_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_declarative_v2_verifier_command_v2" ADD CONSTRAINT "fx_dv2_command_v2_attempt_fk" FOREIGN KEY ("scope_id","attempt_sha256") REFERENCES "fx_system_declarative_v2_verifier_attempt_v2"("scope_id","attempt_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
