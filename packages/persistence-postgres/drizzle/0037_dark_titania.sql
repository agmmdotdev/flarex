...
--> statement-breakpoint
ALTER TABLE "fx_system_application_revision_request_v1" ADD CONSTRAINT "fx_application_revision_request_v1_revision_fk" FOREIGN KEY ("scope_id","candidate_sha256","revision_id") REFERENCES "fx_system_application_revision_v1"("scope_id","candidate_sha256","revision_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_application_revision_v1" ADD CONSTRAINT "fx_application_revision_v1_candidate_fk" FOREIGN KEY ("scope_id","candidate_sha256") REFERENCES "fx_system_declarative_v2_candidate"("scope_id","candidate_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_application_revision_v1" ADD CONSTRAINT "fx_application_revision_v1_attempt_fk" FOREIGN KEY ("scope_id","attempt_sha256") REFERENCES "fx_system_declarative_v2_verifier_attempt_v2"("scope_id","attempt_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_application_revision_v1" ADD CONSTRAINT "fx_application_revision_v1_schema_fk" FOREIGN KEY ("deployment_id","schema_version_id") REFERENCES "fx_control_schema_version"("deployment_id","schema_version_id") ON DELETE restrict ON UPDATE no action;
