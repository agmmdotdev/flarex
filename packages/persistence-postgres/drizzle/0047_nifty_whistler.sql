...
ALTER TABLE "fx_control_unique_constraint_definition" ADD CONSTRAINT "fx_control_unique_constraint_definition_logical_fk" FOREIGN KEY ("deployment_id","logical_unique_constraint_id","table_id") REFERENCES "fx_control_unique_constraint"("deployment_id","logical_unique_constraint_id","table_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_unique_constraint" ADD CONSTRAINT "fx_control_unique_constraint_table_fk" FOREIGN KEY ("deployment_id","table_id") REFERENCES "fx_control_table"("deployment_id","table_id") ON DELETE restrict ON UPDATE no action;
