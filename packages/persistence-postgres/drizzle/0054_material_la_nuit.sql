...
--> statement-breakpoint
ALTER TABLE "fx_system_application_analysis_v1" ADD CONSTRAINT "fx_application_analysis_v1_candidate_fk" FOREIGN KEY ("scope_id","candidate_id","source_artifact_root_sha256") REFERENCES "public"."fx_system_application_candidate_v1"("scope_id","candidate_id","source_artifact_root_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_application_candidate_v1" ADD CONSTRAINT "fx_application_candidate_v1_scope_fk" FOREIGN KEY ("scope_id") REFERENCES "public"."fx_system_scope_clock"("scope_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_application_revision_v2" ADD CONSTRAINT "fx_application_revision_v2_analysis_fk" FOREIGN KEY ("scope_id","candidate_id","analysis_id","analysis_status","source_artifact_root_sha256","manifest_sha256") REFERENCES "public"."fx_system_application_analysis_v1"("scope_id","candidate_id","analysis_id","status","source_artifact_root_sha256","manifest_sha256") ON DELETE restrict ON UPDATE no action;