...
ALTER TABLE "fx_system_application_publication_v1" ADD CONSTRAINT "fx_application_publication_v1_revision_fk" FOREIGN KEY ("scope_id","revision_id","candidate_id","analysis_id","source_artifact_root_sha256","manifest_sha256","revision_status") REFERENCES "fx_system_application_revision_v2"("scope_id","revision_id","candidate_id","analysis_id","source_artifact_root_sha256","manifest_sha256","status") ON DELETE restrict ON UPDATE no action;
