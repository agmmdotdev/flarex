...
ALTER TABLE "fx_system_application_task_catalog_v1" ADD CONSTRAINT "fx_application_task_catalog_v1_publication_fk" FOREIGN KEY ("scope_id","revision_id","candidate_id","analysis_id","source_artifact_root_sha256","publication_sha256") REFERENCES "public"."fx_system_application_publication_v1"("scope_id","revision_id","candidate_id","analysis_id","source_artifact_root_sha256","publication_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_system_application_task_definition_v1" ADD CONSTRAINT "fx_application_task_definition_v1_catalog_fk" FOREIGN KEY ("scope_id","revision_id","task_catalog_binding_sha256") REFERENCES "public"."fx_system_application_task_catalog_v1"("scope_id","revision_id","task_catalog_binding_sha256") ON DELETE restrict ON UPDATE no action;
