...
ALTER TABLE "fx_control_application_manifest_schema_binding" ADD CONSTRAINT "fx_control_application_manifest_schema_binding_schema_fk" FOREIGN KEY ("deployment_id","application_schema_sha256","schema_version_id","schema_version","bound_publication_sha256") REFERENCES "fx_control_bound_application_schema"("deployment_id","application_schema_sha256","schema_version_id","schema_version","bound_publication_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_bound_application_schema" ADD CONSTRAINT "fx_control_bound_application_schema_artifact_fk" FOREIGN KEY ("deployment_id","schema_version_id","schema_version","schema_manifest_sha256") REFERENCES "fx_control_schema_version"("deployment_id","schema_version_id","version","manifest_sha256") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_edge_definition" ADD CONSTRAINT "fx_control_edge_definition_relation_fk" FOREIGN KEY ("deployment_id","relation_id") REFERENCES "fx_control_relation"("deployment_id","relation_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_edge_definition" ADD CONSTRAINT "fx_control_edge_definition_schema_fk" FOREIGN KEY ("deployment_id","created_by_schema_version_id") REFERENCES "fx_control_schema_version"("deployment_id","schema_version_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_relation" ADD CONSTRAINT "fx_control_relation_schema_fk" FOREIGN KEY ("deployment_id","created_by_schema_version_id") REFERENCES "fx_control_schema_version"("deployment_id","schema_version_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_schema_relation_binding" ADD CONSTRAINT "fx_control_schema_relation_binding_schema_fk" FOREIGN KEY ("deployment_id","schema_version_id") REFERENCES "fx_control_schema_version"("deployment_id","schema_version_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_schema_relation_binding" ADD CONSTRAINT "fx_control_schema_relation_binding_relation_fk" FOREIGN KEY ("deployment_id","relation_id") REFERENCES "fx_control_relation"("deployment_id","relation_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_schema_relation_binding" ADD CONSTRAINT "fx_control_schema_relation_binding_edge_fk" FOREIGN KEY ("deployment_id","edge_definition_id","relation_id") REFERENCES "fx_control_edge_definition"("deployment_id","edge_definition_id","relation_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_schema_relation_binding" ADD CONSTRAINT "fx_control_schema_relation_binding_source_table_fk" FOREIGN KEY ("deployment_id","source_table_id") REFERENCES "fx_control_table"("deployment_id","table_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_schema_relation_binding" ADD CONSTRAINT "fx_control_schema_relation_binding_target_table_fk" FOREIGN KEY ("deployment_id","target_table_id") REFERENCES "fx_control_table"("deployment_id","table_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "fx_control_schema_relation_binding" ADD CONSTRAINT "fx_control_schema_relation_binding_origin_fk" FOREIGN KEY ("deployment_id","origin_schema_version_id","origin_relation_ordinal") REFERENCES "fx_control_schema_relation_binding"("deployment_id","schema_version_id","relation_ordinal") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
