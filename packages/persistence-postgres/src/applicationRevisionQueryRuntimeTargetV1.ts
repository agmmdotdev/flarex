...
export interface ApplicationRevisionQueryRuntimeTargetFunctionV1 {
...
export interface ApplicationRevisionQueryRuntimeTargetAuthorityV1 {
...
export class ApplicationRevisionQueryRuntimeTargetV1Error
  extends Data.TaggedError("ApplicationRevisionQueryRuntimeTargetV1Error")<{
    readonly reason:
      | "unknownFunction"
      | "unsupportedFunction"
      | "snapshotMismatch"
...
export type ClaimApplicationRevisionQueryRuntimeTargetAuthorityV1Error =
  | InvalidActiveApplicationRevisionSelectionV1Error
  | InvalidApplicationPointQuerySnapshotV1Error
 ...
 */
export const claimApplicationRevisionQueryRuntimeTargetAuthorityV1 = Effect.fn(
  "ApplicationRevisionQueryRuntimeTarget.claimAuthorityV1",
)(function* (
  ...
  ApplicationRevisionQueryRuntimeTargetAuthorityV1,
  ClaimApplicationRevisionQueryRuntimeTargetAuthorityV1Error
> {
  ...
  if (
    ...
    return yield* new ApplicationRevisionQueryRuntimeTargetV1Error({
