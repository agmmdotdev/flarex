...
export function makeCommerceCommandContext(
  lifetime: BoundedRequestLifetime<CommerceTransactionError>, working: Pick<Effect.Success<ReturnType<typeof makeCommerceStore>>, "store" | "table">,
  ...
  return Object.freeze({ manager, store: working.store,
