  ...
  table => [
    ...
    check(
      ...
      sql`${table.admissionStorageId} between 1 and ${sql.raw(MAX_INT64)}
        ...
        and ((${table.frameVersion} = 1 and ${table.admissionProfile} in ('synthetic-system-fresh', 'synthetic-medusa-fresh', 'payload-preferences-fresh', 'registered-commerce-fresh'))
