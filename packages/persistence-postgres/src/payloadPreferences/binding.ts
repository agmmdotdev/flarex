...
export const verifyPayloadPreferenceBinding = Effect.fn("PayloadPreferences.verifyBinding")(function* (
  ...
  const expected = many?.configSha256 === content.configSha256 ? many : yield* capturePayloadPreferenceProfile(binding.installation.artifact.deploymentId, count === 0 ? "payload.scalar" : count === 1 ? "payload.content-relations" : "payload.content-many");
