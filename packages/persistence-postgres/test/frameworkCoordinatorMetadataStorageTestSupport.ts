...
const expectedColumnSignatures = [
  ...
  "fx_system_framework_migration_plan_base|plan_storage_id:int8:!:-:-,collision_storage_id:int8:!:-:-,base_plan_storage_id:int8:!:-:-,installation_storage_id:int8:!:-:-,installation_sha256:bytea:!:-:-,installation_receipt_sha256:bytea:!:-:-,readiness_storage_id:int8:!:-:-,readiness_sha256:bytea:!:-:-,physical_layout_sha256:bytea:!:-:-",
...
const expectedForeignKeySignatures = [
  ...
  "fx_framework_migration_base_candidate_fk|fx_system_framework_migration_plan_base|plan_storage_id,collision_storage_id|fx_system_framework_migration_plan|plan_storage_id,collision_storage_id",
  "fx_framework_migration_base_context_fk|fx_system_framework_migration_plan_base|installation_storage_id,collision_storage_id,base_plan_storage_id,physical_layout_sha256|fx_system_framework_schema_installation|installation_storage_id,collision_storage_id,plan_storage_id,installed_structure_sha256",
  "fx_framework_migration_base_installation_fk|fx_system_framework_migration_plan_base|installation_storage_id,installation_sha256,installation_receipt_sha256|fx_system_framework_schema_installation|installation_storage_id,installation_sha256,installation_receipt_sha256",
  "fx_framework_migration_base_readiness_fk|fx_system_framework_migration_plan_base|readiness_storage_id,installation_storage_id,readiness_sha256|fx_system_framework_schema_readiness|readiness_storage_id,installation_storage_id,readiness_sha256",
...
export async function expectFrameworkCoordinatorMetadataStorageCatalog(
  ...
  expect(defaults.rows).toEqual([
    ...
    "fx_system_framework_migration_plan_admission",
    "fx_system_framework_migration_step_receipt",
  ].map(table_name => ({ table_name, column_name: "created_transaction_id", column_default: "txid_current()" })));
