...
} from "../../flarex-backend/src/deployment/PrivateApplicationRevisionReadinessCoordinatorV1";
import {
  probeDeclarativeV2ColdMaterializationV1,
} from "../../flarex-backend/src/artifactRuntime/DeclarativeV2ColdMaterializationProbe";
...
import type { LoadedCandidateRuntimePublicationV1 } from
  "../src/candidateRuntimePublicationRepositoryV1";
import {
...
export function readinessContext(
  ...
  runtimeArtifacts: ReturnType<typeof makeRuntimeArtifactPublisherFixtureV1>,
