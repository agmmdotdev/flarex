...
/**
 * Private Standard mutation consumer. The Application system owns coherent
 * active selection, grant issuance, admission, and execution composition;
 * this boundary does not retain a legacy fallback or translate owner results.
 */
