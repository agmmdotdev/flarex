...
import {
  ...
  type MemoryRuntimeArtifactStoreV1,
...
} from "@flarex/persistence-postgres/internal/system-test/functionMetadataCodec";
import {
  hashFunctionMetadataSha256V1,
} from "@flarex/persistence-postgres/internal/system-test/functionMetadataSha256";
...
// Test-owned finite ceiling covering the generated accepted source domain.
// Production admission policy is not derived from this simulation constant.
const STANDARD_APPLICATION_COMMAND_MAXIMUM = 1_000_000_000_000n;
...
export interface Fsv03PrivateAnalyzerToPostgresLaneV1 {
  ...
  readonly runtimeArtifacts?: MemoryRuntimeArtifactStoreV1;
  ...
  commandBudgetMaximum = MAXIMUM,
    ...
    const registrationContext = makeApplicationRevisionRegistrationContextV1({
      ...
      runtimeArtifactPublisher:
        (lane.runtimeArtifacts ?? makeMemoryRuntimeArtifactStoreV1())
          .publisher,
    });
...
function aavA1DefinitionInput(): StandardApplicationDefinitionInputV1 {
  return {
    programBudgetInput: {
      maximumModules: 1,
      maximumFunctions: 1,
    ...
    graphInput: {
      modules: [{
        ...
        roles: ["function", "execution"],
        sourceBytes: UTF8.encode(
          "export async function send() { return { sent: true }; }\n" +
            "export function run() {}\n",
        ),
        sourceMapBytes: null,
      }],
      functionEntries: [{
        logicalModulePath: "actions",
        artifactModulePath: "actions.js",
      }],
      executionPath: "actions.js",
      schemaPath: null,
      authPath: null,
    },
  };
