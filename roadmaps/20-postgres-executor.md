...
9. **Retry classes remain separate.** O08-A exact-attempt replacement, O08-B1
   ...
   redispatch, O08-B2b2b1 bounded inert discovery, O08-B2b2b2 scheduling/
   redelivery and production dispatch,
...
epoch-provenance constraints, inert retained floor, and bounded contiguous
  ...
  composes private exact-selector replay/expiry, busy/non-dispatchable closure,
  one pristine execution, sealed finish-only, and existing finishing recovery.
  O08-B2b2b1 now supplies bounded inert discovery. C06-B delivery/replay
  orchestration and O08-B2b2b2 scheduling/redelivery and production dispatch
...
logical point planning is complete. S08's additive native commit/change-feed
  ...
  redispatch, and O08-B2b2b1 bounded inert discovery are complete; O08-B2b2b2
  scheduling/redelivery and production dispatch plus C06-B endpoint/response
  policy are deferred Wave 2
