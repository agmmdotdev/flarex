...
9. **Retry classes remain separate.** O08-A exact-attempt replacement, O08-B1
   ...
   coherence and O08-B2b2b2b0b atomic seal-time lease promotion, pending O08-
   B2b2b2b1 execution-claim liveness, and later scheduling/redelivery and production dispatch,
...
epoch-provenance constraints, inert retained floor, and bounded contiguous
  ...
  now supplies atomic seal-time lease promotion. C06-B delivery/replay
  orchestration, O08-B2b2b2b1 execution-claim liveness, and scheduling/
...
logical point planning is complete. S08's additive native commit/change-feed
  ...
  and O08-B2b2b2b0b atomic seal-time lease promotion are complete; O08-
  B2b2b2b1 phase-aware execution-claim liveness, production scheduling/
  redelivery and dispatch, and C06-B endpoint/response policy are deferred Wave 2
