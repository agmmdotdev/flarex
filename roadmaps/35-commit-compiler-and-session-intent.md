...
9. **O08-B2b2b2b policy and C06-B dispatch:** b0a's value-based grant/retention
   coherence, b0b atomic seal-time lease promotion, b1a phase-aware renewal,
   and b1b1 host-neutral structured liveness are complete. B1b2 production
   scheduling/redelivery and dispatch plus C06-B endpoint response, routing,
   and runtime adapters remain deferred. They must compose the singular
   Postgres claim and may not infer authority from lifecycle or discovery
   evidence.
