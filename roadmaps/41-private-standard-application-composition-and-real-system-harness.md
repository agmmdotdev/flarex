...
Cooking's first query-bearing, mutation-bearing, concurrent duplicate-delivery,
and lost-completion-response Task scenarios now pass after C0 through C4.
Further app Task coverage must remain separately bounded.
