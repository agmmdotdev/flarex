...
| [`42-standard-application-apis.md`](./42-standard-application-apis.md) and [`50-clean-application-apis.md`](./50-clean-application-apis.md) | Stable workspace-internal application stages plus the accepted clean API migration. `CAPI-A` provides the private unversioned Application Definition facade; invocation, consumer migration, public, and production gates remain pending. Concrete wire and persisted contracts keep versions where exact compatibility requires them. |
