...
| [`45-private-internal-user-code-calls.md`](./45-private-internal-user-code-calls.md) | `SAP06-A1` complete privately; later call classes remain separately gated | Query-to-internal-query runs inline inside one SAP05 Scope and PQV-A1 snapshot through its separate private target/profile/ABI. It adds no schema, transaction owner, route, or public internal-function invocation; mutation call directions remain separate gates. |
