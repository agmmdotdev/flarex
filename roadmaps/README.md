...
| [`shared-transaction-core/`](./shared-transaction-core/README.md) | Cross-profile transaction/publication/recovery ownership reconciliation, remaining-work audit, replacement and cleanup obligations, and performance/completion gates. The bounded publication extraction is complete; the broader audit remains pending. |
