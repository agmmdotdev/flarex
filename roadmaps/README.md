...
| [`flarexdb-foundation/04-payload-relational-contract.md`](./flarexdb-foundation/04-payload-relational-contract.md) | Active private native relation plan; `R01`, `R01-P`, `R02`, `S12`, `C09`, and production-inert `E01-A` complete | Current private authenticated executable modules -> Application Analysis/Application Manifest -> R02 binding -> S12/C09 storage maintenance -> E01-A physical build/readiness -> E01-B Application readiness/reuse fold -> O10-R -> RA01 -> RQ01 -> R03 -> SV-R. No relation runtime read, OCC registration, activation, public syntax, Payload adapter, or production cutover is active. |
