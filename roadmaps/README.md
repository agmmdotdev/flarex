...
| [`45-private-internal-user-code-calls.md`](./45-private-internal-user-code-calls.md) | `SAP06-A1` and `SAP06-A2` complete privately; `SAP06-A3` remains gated | Query-to-internal-query runs inline inside one SAP05 Scope/PQV-A1 snapshot. Mutation-to-internal-query runs inside the exact SAP04 Worker and C03 live overlay under three separate private identities, with no child publication, schema change, route, or public invocation. Internal-mutation entry authority remains open. |
