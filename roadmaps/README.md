...
| [`45-private-internal-user-code-calls.md`](./45-private-internal-user-code-calls.md) | `SAP06-A1` complete privately; `SAP06-A2` implementation preflight complete and separately gated | Query-to-internal-query runs inline inside one SAP05 Scope/PQV-A1 snapshot. The next proposed mutation-to-internal-query slice instead reuses the exact mutation Worker and C03 live overlay; its three new private identities require implementation approval and add no schema, transaction owner, route, or public invocation. |
