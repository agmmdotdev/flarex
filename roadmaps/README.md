...
| [`46-private-standard-edge-action-vertical.md`](./46-private-standard-edge-action-vertical.md) | AAV-A1 accepted and complete privately; AAV-A2 is next | Existing `edge_action` publication, R2 materialization, readiness, and active selection now compose with direct invocation and shared uncertainty authority. AAV-A2 and private route-independent SAP07 remain later gates. |
