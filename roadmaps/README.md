...
| [`shared-transaction-core/`](./shared-transaction-core/README.md) | Cross-profile transaction/publication/recovery ownership reconciliation, replacement and cleanup obligations, and performance/completion gates. Publication extraction and source ownership audit are complete; neutral physical resource ownership and CMS participant/materialization replacements are proposed, with implementation and measured validation pending. |
