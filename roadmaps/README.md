...
| [`45-private-internal-user-code-calls.md`](./45-private-internal-user-code-calls.md) | Implementation preflight complete; `SAP06-A1` awaits explicit approval | The first internal-call slice is query-to-internal-query inline inside one SAP05 Scope and PQV-A1 snapshot. It requires a new private target/profile/ABI but no schema, transaction owner, route, or public internal-function invocation; mutation call directions remain separate gates. |
