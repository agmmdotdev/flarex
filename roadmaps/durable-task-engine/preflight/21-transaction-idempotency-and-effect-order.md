...
proofs pass. The canonical lane now executes 61 transition-derived histories
through the adapter and two invalid commands at the decoder boundary; two
histories and final DTE04-B review remain open. Creation is a separate
...
vectors, sends 61 transition-derived histories through the concrete
...
other two histories require a non-transition cursor fixture or explicit
overflow-corruption setup.
