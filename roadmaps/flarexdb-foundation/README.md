...
completed private kernel through host-neutral structured claim liveness
  ...
  -> O08-B2b2b2b1b2b production scheduling/redelivery and dispatch
...
sweep are complete; O08-B2b2b2b1b2b production scheduling/redelivery and C06-B
...
9. `O08` (partially complete):
   ...
   - `O08-B2a` (complete): immediate outcome/liveness/canonical-input
    ...
    - `O08-B2b2` (partially complete):
      ...
      - `O08-B2b2b2b1b2b` (pending and unapproved): scope enumeration,
        repeated-page scheduling/redelivery, routing, and production dispatch;
...
18. `O08-B2b2b2b1b2b` + `C06-B` (pending): scope enumeration, repeated-page
    scheduling/redelivery, production dispatch, and stable `/invoke/*`
    endpoint/response policy.
19. `C07`: PGlite plus real-Postgres correctness gate.
...
host-neutral redelivery page. O08-B2b2b2b1b2b and C06-B still require scope
enumeration, repeated-page scheduling/redelivery, production-liveness, routing,
and endpoint preflights.
