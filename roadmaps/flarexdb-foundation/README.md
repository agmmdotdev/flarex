...
completed private kernel through host-neutral structured claim liveness
  -> O08-B2b2b2b1b2 production scheduling/redelivery and dispatch
...
coordinator are complete; O08-B2b2b2b1b2 production scheduling/redelivery and
...
9. `O08` (partially complete):
   ...
   - `O08-B2a` (complete): immediate outcome/liveness/canonical-input
    ...
    - `O08-B2b2` (partially complete):
      ...
      - `O08-B2b2b2b1b2` (pending and unapproved): scheduling/redelivery and
        production dispatch;
...
17. `O08-B2b2b2b1b2` + `C06-B` (pending): scheduling/redelivery, production
    dispatch, and stable `/invoke/*` endpoint/response policy.
18. `C07`: PGlite plus real-Postgres correctness gate.
...
closes host-neutral structured liveness. O08-B2b2b2b1b2 and C06-B still
require scheduling/redelivery, production-liveness, and endpoint preflights.
