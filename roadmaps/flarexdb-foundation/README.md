...
possible schema-design step is the additive `M05-C1-P` purge-progress
preflight, followed by a separately proven reactivation contract before any
destructive sidecar page. Developer-index sidecars, unique claims, and
immutable evidence remain distinct later owners; no deletion or automatic
