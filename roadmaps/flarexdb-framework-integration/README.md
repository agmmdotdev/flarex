...
a separate authority and recovery capability. Bounded Payload reverse joins
are the next consumer preflight, with their own query and response gate. This does not complete
