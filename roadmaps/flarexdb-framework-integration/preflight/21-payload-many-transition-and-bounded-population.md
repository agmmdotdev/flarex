...
| `packages/persistence-postgres/src/payloadScalar/runtime.ts` and `adapter.ts` | Public command arguments fix depth zero; adapter predicates admit only ID/title equality, and nonempty projections/joins are rejected. |
