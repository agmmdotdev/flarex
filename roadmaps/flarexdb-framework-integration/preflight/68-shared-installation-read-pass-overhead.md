...
The [typed assignment-verification experiment](./70-typed-physical-assignment-verification.md)
confirmed repeated structural validation after an exact-byte verified immutable
result. Its candidate was also withdrawn because the installation measurements
did not establish the agreed reproducible meaningful benefit. Neither experiment
authorizes broader assignment-row or ledger reuse.
