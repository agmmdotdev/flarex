...
| `collision_head` | Retain existing sole mutable row and its CAS for this receipt cutover. Its complete columns are `collision_storage_id`, `current_plan_storage_id`, `current_plan_sha256`, `current_admission_storage_id`, `current_admission_sha256`, `head_revision`, `attempt_fence`, `current_attempt_storage_id`, `current_attempt_id`, `current_attempt_fence`, `current_lease_owner_id`, `current_lease_expires_at`, `last_event_storage_id`, `last_event_sequence`, `last_event_sha256`, `collision_head_sha256`, `frame_format`, `frame_version`, `canonical_byte_length`, `canonical_bytes`. The later operational transition must extend this row with a completed position and exact receipt commitment; it must not create another head. |
