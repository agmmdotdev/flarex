...
const allowedRunPromiseSites = new Map([
  ...
  [siteKey("packages/flarex-dev/src/backendPush.ts", "HttpBackendPushCoordinator.post"), 2],
  [siteKey("packages/flarex-dev/src/backendPush.ts", "HttpBackendPushCoordinator.postFinish"), 2],
  [siteKey("packages/flarex-dev/src/backendPush.ts", "HttpBackendSourceAnalyzer.analyze"), 1],
  [siteKey("packages/flarex-dev/src/backendPush.ts", "LocalBackendPushCoordinator.finish"), 2],
  ...
  [siteKey("packages/persistence-postgres/src/scopeAuthorityResolution.ts", "resolveLocatedTrustedScopeAuthority"), 1],
  [siteKey("packages/persistence-postgres/src/transactionSessionActivation.ts", "runTransactionSessionAuthorityResolution"), 1],
]);
