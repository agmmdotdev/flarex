...
const allowedRunPromiseSites = new Map([
  ...
  [siteKey("packages/persistence-postgres/src/pointCommitTransaction.ts", "resetPointCommitUniqueConstraintValidation"), 1],
  [siteKey("packages/persistence-postgres/src/pointCommitTransaction.ts", "runPointCommitInTransactionEffect"), 1],
