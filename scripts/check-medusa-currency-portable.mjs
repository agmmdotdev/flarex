...
for (const entry of ["packages/medusa-sales-channel/src/static-manifest.ts", "packages/medusa-adapter/src/sales-channel-schema.ts", "packages/medusa-adapter/src/sales-channel-service.ts", "packages/medusa-currency/src/static-manifest.ts", "packages/medusa-adapter/src/currency-service.ts", "packages/medusa-adapter/src/product-schema.ts", "packages/medusa-adapter/src/product-service.ts", "packages/medusa-core-flows/src/product/workflows/create-product-tags.ts", "packages/medusa-core-flows/src/product/workflows/update-product-tags.ts", "packages/medusa-core-flows/src/product/workflows/delete-product-tags.ts", "packages/medusa-workflows-sdk/src/runtime.ts", "packages/medusa-adapter/src/product-tag-workflow.ts", "packages/medusa-adapter/src/product-tag-update-workflow.ts", "packages/medusa-adapter/src/product-tag-delete-workflow.ts", "packages/medusa-core-flows/src/product/workflows/batch-variant-images.ts", "packages/medusa-adapter/src/product-variant-images-workflow.ts", "packages/medusa-adapter/src/product-tag-composition.ts", "packages/medusa-adapter/src/product-relationships-workflow.ts"]) {
await build({
  configFile: false,
  logLevel: "silent",
