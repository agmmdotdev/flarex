...
const findWorkspaceRoot = (start = process.cwd()) => {
...
async function watch(
  ...
  const realCopyPath = (arg) => {
    ...
    fs.copy(oldPath, newPath, (err) => {
      ...
      // permissions that it is given when installed via a package manager.
      // This fixes the issue where after running medusa-dev, running `medusa develop`
