...
const distributedTransactionGlobal = globalThis as typeof globalThis & {
  DistributedTransaction?: typeof DistributedTransaction
}

distributedTransactionGlobal.DistributedTransaction ??= DistributedTransaction
const GlobalDistributedTransaction =
  distributedTransactionGlobal.DistributedTransaction
