...
import { isErrorLike } from "@medusajs/utils/common/is-error-like"
import { serializeError } from "@medusajs/utils/common/serialize-error"
import { promiseAll } from "@medusajs/utils/common/promise-all"
import { TransactionStepState } from "@medusajs/utils/orchestration/types"
...
export class TransactionOrchestrator extends EventEmitter {
  ...
  private createTransactionFlow(
    ...
    const flow: TransactionFlow = {
      ...
      runId: context?.runId ?? createPortableId("run"),
