import type { Context, MedusaContainer } from "@medusajs/types"
import {
...
const workflowManagerGlobal = globalThis as typeof globalThis & {
  WorkflowManager?: typeof WorkflowManager
}

workflowManagerGlobal.WorkflowManager ??= WorkflowManager
const GlobalWorkflowManager = workflowManagerGlobal.WorkflowManager
