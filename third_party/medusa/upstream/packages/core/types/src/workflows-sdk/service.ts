...
export interface WorkflowScheduleRecoveryResultDTO {
  dueCount: number
...
export interface WorkflowDelayedActionRecoveryResultDTO {
  dueCount: number
...
export interface IWorkflowEngineService extends IModuleService {
  ...
  recoverDueSchedules(now?: number): Promise<WorkflowScheduleRecoveryResultDTO>

  recoverDueDelayedActions(
    now?: number
  ): Promise<WorkflowDelayedActionRecoveryResultDTO>
