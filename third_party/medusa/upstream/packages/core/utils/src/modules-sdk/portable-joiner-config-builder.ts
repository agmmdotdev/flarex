...
export { buildModelsNameToLinkableKeysMap } from "./build-models-name-to-linkable-keys-map"

export type JoinerConfigModels = DmlEntity<any, any>[] | { name: string }[]

/**
 * Define joiner config for a module from explicitly imported models.
 *
 ...
 * @param primaryKeys
 */
export function defineJoinerConfigFromModels(
  serviceName: string,
  {
    alias,
    schema,
