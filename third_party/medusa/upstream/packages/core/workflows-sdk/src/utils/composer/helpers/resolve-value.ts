...
} from "@medusajs/utils/common/parse-stringify-if-necessary"
import { isObject } from "@medusajs/utils/common/is-object"
...
function isWorkflowReference(value: InputObject): boolean {
  return (
    value.__type === OrchestrationUtils.SymbolInputReference ||
    value.__type === OrchestrationUtils.SymbolMedusaWorkflowResponse ||
    value.__type === OrchestrationUtils.SymbolWorkflowStepTransformer ||
    value.__type === OrchestrationUtils.SymbolWorkflowStep ||
    value.__type === OrchestrationUtils.SymbolWorkflowStepResponse ||
    value.__type === OrchestrationUtils.SymbolWorkflowWorkflowData
  )
}
...
function unwrapInput({
  ...
  if (isWorkflowReference(inputTOUnwrap)) {
