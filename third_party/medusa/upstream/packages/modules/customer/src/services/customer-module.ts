...
type InjectedDependencies = {
  ...
  customerService: ModulesSdkTypes.IMedusaInternalService<
    InferEntityType<typeof Customer>
  >
  customerAddressService: ModulesSdkTypes.IMedusaInternalService<
    InferEntityType<typeof CustomerAddress>
  >
  customerGroupService: ModulesSdkTypes.IMedusaInternalService<
    InferEntityType<typeof CustomerGroup>
  >
  customerGroupCustomerService: ModulesSdkTypes.IMedusaInternalService<
