  ...
  testSuite: ({ service }) => {
    describe("Payment Module Service", () => {
      ...
      describe("PaymentCollection", () => {
        beforeEach(async () => {
          await createPaymentCollections(service)
          await createPaymentSessions(service)
          await createPayments(service)
        })
      ...
      describe("PaymentSession", () => {
        ...
        describe("create", () => {
          ...
          it("should gracefully handle payment session creation fails from external provider", async () => {
            ...
            const deleteProviderSessionMock = vi.spyOn(
              (service as any).paymentProviderService_,
              "deleteSession"
            )

            const deletePaymentSessionMock = vi.spyOn(
        ...
        describe("authorize", () => {
          ...
          it("should auto capture payment when provider returns captured status", async () => {
            ...
            const capturePaymentMock = vi.spyOn(
              (service as any).paymentProviderService_,
              "capturePayment"
            )
