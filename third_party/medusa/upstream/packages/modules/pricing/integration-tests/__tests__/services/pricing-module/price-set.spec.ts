...
moduleIntegrationTestRunner<IPricingModuleService>({
  ...
  testSuite: ({ service }) => {
    ...
    beforeEach(() => {
      eventBusEmitSpy = vi.spyOn(MockEventBusService.prototype, "emit")
    })
      ...
      describe("retrieve", () => {
        ...
        it("should throw an error when a id is not provided", async () => {
          ...
          try {
            ...
            await service.retrievePriceSet(undefined)
          } catch (e) {
            error = e
          }
        ...
        it("should create a price set with rule types and money amounts", async () => {
          ...
          expect(events[2]).toEqual(
            composeMessage(PricingEvents.PRICE_RULE_CREATED, {
              ...
              object: "price_rule",
              data: {
                id: priceSet.prices![0].price_rules![0].id,
              },
            })
          )
        })
                ...
                prices: [
                  {
                    ...
                    rules: {
                      custom_rule: [
                        {
                          // @ts-expect-error intentionally validates invalid operator handling.
                          operator: "unknown",
                          value: 500,
                        },
                      ],
                ...
                prices: [
                  {
                    ...
                    rules: {
                      custom_rule: [
                        {
                          operator: "gt",
                          // @ts-expect-error intentionally validates invalid value handling.
                          value: "string",
                        },
                      ],
                    },
...
async function seedPriceSetData(service: IPricingModuleService) {
  const priceSets: SeedPriceSetDTO[] = [
    {
      id: "price-set-1",
      prices: [
