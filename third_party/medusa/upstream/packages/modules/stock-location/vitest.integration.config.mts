...
const STOCK_LOCATION_INTEGRATION_TIMEOUT = 100_000
...
export default defineNodeVitestIntegrationConfig({
  ...
  hookTimeout: STOCK_LOCATION_INTEGRATION_TIMEOUT,
  include: [
    "integration-tests/__tests__/stock-location-module-service.spec.ts",
  ],
  legacyJestBridge: false,
  root: packageRoot,
  testTimeout: STOCK_LOCATION_INTEGRATION_TIMEOUT,
})
