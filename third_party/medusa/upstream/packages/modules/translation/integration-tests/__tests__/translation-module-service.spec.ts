    ...
    describe("Translation Module Service", () => {
      ...
      describe("Translation", () => {
        ...
        describe("listing and counting translations", () => {
          ...
          it("should apply q filter before pagination and count all matches", async () => {
            await service.createTranslations([
              {
                reference_id: "cnt_page_1",
                reference: "product",
                locale_code: "en-US",
                translations: { title: "Page Match One" },
              },
              {
                reference_id: "cnt_page_2",
                reference: "product",
                locale_code: "en-US",
                translations: { title: "Page Match Two" },
              },
              {
                reference_id: "cnt_page_3",
                reference: "product",
                locale_code: "en-US",
                translations: { title: "Page Match Three" },
              },
            ])
            ...
            const [countedTranslations, count] =
              await service.listAndCountTranslations(
                {
                  q: "page match",
                },
            ...
            expect(translations).toHaveLength(2)
            expect(countedTranslations).toHaveLength(2)
            expect(count).toEqual(3)
          })
        })
