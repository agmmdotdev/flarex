...
import { nodeWorkflowSchedulerAdapter } from "../../src/node-scheduler-adapter"
...
moduleIntegrationTestRunner<IWorkflowEngineService>({
  ...
  resolve: __dirname + "/../..",
  moduleDependencies: ["workflowSchedulerAdapter"],
  injectedDependencies: {
    workflowSchedulerAdapter: nodeWorkflowSchedulerAdapter,
  },
