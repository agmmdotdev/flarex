...
> extends ModulesSdkUtils.MedusaService<{
  ...
  async recoverDueSchedules(
    ...
    return await this.workflowOrchestratorService_.recoverDueSchedules(now)
  }

  async recoverDueDelayedActions(
    now?: number
  ): Promise<WorkflowDelayedActionRecoveryResult> {
    return await this.workflowOrchestratorService_.recoverDueDelayedActions(now)
  }

  async clearExpiredExecutions(): Promise<void> {
    await this.workflowOrchestratorService_.clearExpiredExecutions()
  }
}
